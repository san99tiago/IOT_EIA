//CODIGO TRANSMISOR DE SERIAL ALTERNATIVA PARA ENVIAR PALABRA A OTRO PIC18F2550
...
void enviar_palabra (char palabra_a_enviar []); //Para enviar palabra como tal
void putch (char data); //Para enviar caracteres simples por serial (ver abajo)
