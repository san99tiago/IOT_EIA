...
var new_datos_usuario = {
    ...
    nuevo_sexo: "0",    
    nuevo_pais: '0',
    nuevo_perfil: "U", ///Unica forma de ser admin es desde base de datos directamente
    nuevo_password_1: '0',
    nuevo_password_2: '1'
};
...
document.getElementById('crear_usuario').addEventListener('click', function() 
{
    ...
    new_datos_usuario.nuevo_apellido = document.getElementById("new_apellido").value;
    new_datos_usuario.nuevo_usuario = document.getElementById("new_usuario").value;
    new_datos_usuario.nuevo_edad = document.getElementById("new_edad").value;
    new_datos_usuario.nuevo_sexo = document.getElementById("new_sexo").value;
    new_datos_usuario.nuevo_pais = document.getElementById("new_pais").value;
